var markers = {
  ...
  catho(){
    ...
    let markerCATHO = L.marker([50.63327,3.04635],{icon:catho }).addTo(theMap).on('click',function(e) { leftPan.open(this._latlng.lat,this._latlng.lng,"Catho");});
  },
  yncrea(){
    let yncrea = L.icon({
  ...
  bus(){
    ...
    let markerBUS6 = L.marker([50.63452,3.03028],{icon:bus }).addTo(theMap).on('click',function(e) { leftPan.open(this._latlng.lat,this._latlng.lng,"BusBoisBlanc1");}); //boisblanc
    let markerBUS7 = L.marker([50.63487,3.03023],{icon:bus }).addTo(theMap).on('click',function(e) { leftPan.open(this._latlng.lat,this._latlng.lng,"BusBoisBlanc2");}); //boisblanc
    ...
    let markerBUS15 = L.marker([50.63353,3.01944],{icon:bus }).addTo(theMap).on('click',function(e) { leftPan.open(this._latlng.lat,this._latlng.lng,"BusEuratech1");}); //euratechnologies
